    ...
    <div className="max-w-xl mx-auto mt-10 p-4">
      {!imageUrl && (
        <>
          ...
          <p className="mb-4">{step === 0 ? `Hi! I’ll help you create a custom greeting card for any occasion. Just type something to get started!` : questions[step].prompt}</p>
          <input
          ...
          />
          <button className="bg-blue-600 text-white px-4 py-2 rounded" onClick={handleNext} disabled={loading}>Next</button>
        </>
      )}
